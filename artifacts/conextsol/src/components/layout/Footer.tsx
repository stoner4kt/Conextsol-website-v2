    ...
    <footer className="bg-[#1c1917] text-white pt-20 pb-10 border-t-2 border-stone-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-orange-50/80 text-sm leading-relaxed max-w-xs">
              South Africa's results-driven web design and custom software
              development studio. We build digital assets that grow your
              business.
            </p>
            ...
            <ul className="space-y-4">
              <li>
                <Link
                  ...
                  className="text-orange-50/80 hover:text-white transition-colors text-sm"
                >
                  Website Design
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-orange-50/80">
              <li>
                ...
                <br />
                <a
                  href="mailto:info@conextsol.co.za"
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-orange-50/65">
          <p>
            © {new Date().getFullYear()} Conextsol. All rights reserved. Fully
            POPIA Compliant.
          </p>
