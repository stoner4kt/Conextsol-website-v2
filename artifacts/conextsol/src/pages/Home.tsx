    ...
    <Layout>
      ...
      <section className="relative pt-24 pb-28 lg:pt-36 lg:pb-36 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            >
              <Link href="/contact" className="w-full sm:w-auto px-8 py-4 bg-primary text-primary-foreground font-black rounded-2xl text-lg border-2 border-stone-900/80 shadow-[6px_6px_0_rgba(28,25,23,0.28)] hover:-translate-y-1 hover:shadow-[9px_9px_0_rgba(28,25,23,0.28)] transition-all duration-300">
                Get Your Free Quote
              </Link>
              <a
      ...
      <section className="py-24 bg-[radial-gradient(circle_at_10%_20%,hsl(var(--secondary)/0.12),transparent_22rem),linear-gradient(180deg,hsl(var(--background)),hsl(var(--muted)/0.75))]">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="font-[Space_Grotesk] text-4xl md:text-5xl font-black text-foreground mb-4 tracking-[-0.045em]">Our Core Services</h2>
      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="font-[Space_Grotesk] text-4xl md:text-5xl font-black text-foreground mb-4 tracking-[-0.045em]">Why South African Businesses Choose Us</h2>
      ...
      <section className="py-24 bg-[#1c1917] text-white relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-orange-50/85">A streamlined approach that takes your project from concept to high-converting reality.</p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="relative group">
                ...
                {i < 3 && <div className="hidden md:block absolute top-8 -right-4 w-8 border-t-2 border-dashed border-orange-200/40" />}
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            <div className="max-w-2xl">
              <h2 className="font-[Space_Grotesk] text-4xl md:text-5xl font-black text-foreground mb-4 tracking-[-0.045em]">Recent Work</h2>
      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            <div className="max-w-2xl">
              <h2 className="font-[Space_Grotesk] text-4xl md:text-5xl font-black text-foreground mb-4 tracking-[-0.045em]">Latest Insights</h2>
